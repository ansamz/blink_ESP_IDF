...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" rev-parse "${ref}^0"
...
execute_process(
  COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" show-ref "master"
  WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" for-each-ref "--format=%(upstream:short)" "${current_branch}"
      WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
...
execute_process(
  COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" status --porcelain
  WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" rebase --abort
      WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src'."
    ...
    execute_process(
      COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
    )
    execute_process(
      COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" stash pop --quiet
      WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
      )
      execute_process(
        COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
...
if(init_submodules)
  execute_process(
    COMMAND "C:/Users/ansam/.espressif/tools/idf-git/2.39.2/cmd/git.exe" submodule update --recursive --init 
    WORKING_DIRECTORY "C:/Users/ansam/Documents/github/blink/build/_deps/espidflib-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
